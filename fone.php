...
<body>
    ...
    if (isset($_POST['adicionar'])) {
        ...
        $_SESSION['carrinho'][$produto_id] = array(
            'nome' => $produto_nome,
            'preco' => $produto_preco,
            'quantidade' => 1 // Quantidade padrão é 1, ajuste conforme necessário
        );
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <!-- Certifique-se de que cada produto tem um ID único -->
            <!-- O código abaixo é apenas um exemplo para um produto -->
